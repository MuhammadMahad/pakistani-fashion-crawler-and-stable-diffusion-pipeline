...
After all was said and done, here is the [model](https://huggingface.co/mohummadmahad/pakistani-fashion-generator-model-2) I came up with. Pretty good for a first try I might say though of course not perfect.
...
2. The site crawler may have filtered away a lot of unwanted data outline in but it may have missed some things due to how the filters had to be manually coded based on each websites url pathing schemes.
